...
DummyUserAddress = the data we like use from the website 

FilteredMillionDollarHse = this is after i run my code to filter and it will only left with those worth more than a million dollar


FilteredUserHse = this is after i run my code to filter and it will only left with those worth more than a million dollar

MillionDollarHse= is the data from data.gov.sg those house right