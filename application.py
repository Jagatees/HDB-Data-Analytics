...
import test4.scripts.ninety_nine_co.getpagecount as co_firstpage
import test4.scripts.ninety_nine_co.getHTMLfromPage as co_secondpage
import test4.scripts.ninety_nine_co.rename_folder as co_thirdpage
import test4.scripts.ninety_nine_co.scrap_website as co_fourpage
# Importing custom web scraping functions from 'scripts.srx' module
import test4.scripts.srx.getpageCount as srx_firstpage
import test4.scripts.srx.getHTMLfromPage as srx_secondpage
import test4.scripts.srx.getdatafromHTML as srx_thirdpage
# Importing [PENDING] from 'scripts.algo' module
import test4.scripts.algo.ToIntegrate as alogone
# Importing Mergering functions from 'scripts.merger_json' module
import test4.scripts.merger_json.convert_co as convertCo
import test4.scripts.merger_json.clean_co as cleanCo
# Importing Mergering functions from 'scripts.merger_json' module
import test4.scripts.merger_json.convert_srx as convertSRX
import test4.scripts.merger_json.clean_srx as cleanSRX
# Importing Merger Function from 'scripst.merger_json' module
import test4.scripts.merger_json.merger as merger_csv
# Importing custom map plottinh functions from 'scripts.maplayput' module
import test4.scripts.plotting.chrolopleth_maps as mapsone
# Importing Table Plotting functions from 'scripts.map_layout' module
import test4.scripts.plotting.different_plot as table_d
# Importing Clearning for Area from 'scripts.filter' 
import test4.scripts.filter_area.Area as areaCleaning 
